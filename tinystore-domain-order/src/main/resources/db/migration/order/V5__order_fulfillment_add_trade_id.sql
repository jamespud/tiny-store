...
ADD COLUMN IF NOT EXISTS trade_id VARCHAR(64);

CREATE INDEX IF NOT EXISTS idx_fulfillment_package_trade_id ON tinystore_order.fulfillment_package(trade_id);
