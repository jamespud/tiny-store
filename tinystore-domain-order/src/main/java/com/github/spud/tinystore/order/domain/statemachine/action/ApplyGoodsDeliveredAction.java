...
public class ApplyGoodsDeliveredAction extends AbstractApplyAction {
    public ApplyGoodsDeliveredAction(OutboxEventService outboxEventService,
                                     ObjectProvider<AuditRecorder> auditRecorderProvider,
                                     OrderMetrics orderMetrics) {
        super(outboxEventService, auditRecorderProvider, orderMetrics,
            OrderEventTypeConstants.GOODS_DELIVERED, java.util.Map.of());
    }
}