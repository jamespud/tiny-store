...
public class ApplyRefundSucceededAction extends AbstractApplyAction {
    public ApplyRefundSucceededAction(OutboxEventService outboxEventService,
                                      ObjectProvider<AuditRecorder> auditRecorderProvider,
                                      OrderMetrics orderMetrics) {
        super(outboxEventService, auditRecorderProvider, orderMetrics,
            OrderEventTypeConstants.REFUND_SUCCEEDED, java.util.Map.of());
    }
}