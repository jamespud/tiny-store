...
public class ApplyGoodsShippedAction extends AbstractApplyAction {
    public ApplyGoodsShippedAction(OutboxEventService outboxEventService,
                                   ObjectProvider<AuditRecorder> auditRecorderProvider,
                                   OrderMetrics orderMetrics) {
        super(outboxEventService, auditRecorderProvider, orderMetrics,
            OrderEventTypeConstants.GOODS_SHIPPED, java.util.Map.of());
    }
}