...
public class ApplyAutoCompletedAction extends AbstractApplyAction {
    public ApplyAutoCompletedAction(OutboxEventService outboxEventService,
                                    ObjectProvider<AuditRecorder> auditRecorderProvider,
                                    OrderMetrics orderMetrics) {
        super(outboxEventService, auditRecorderProvider, orderMetrics,
            OrderEventTypeConstants.ORDER_LIFECYCLE_CHANGED, java.util.Map.of("auto", true));
    }
}