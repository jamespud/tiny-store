...
public class SubOrder {
	...
	private final String subOrderNo;         // 子订单号（业务唯一，如“DO_S_20240520xxxx”）
	private final String mainOrderNo;        // 关联主订单号（外键）
	private final String merchantId;         // 商家ID（子订单核心关联，1个子订单1个商家）
	private final String merchantName;       // 商家名称（冗余，避免后续查询商家服务）
	@Setter
	private SubOrderStatus subStatus;        // 子订单状态（SUB_PENDING_PAY：待支付；SUB_PAID：已支付；SUB_SHIPPED：已发货...）
