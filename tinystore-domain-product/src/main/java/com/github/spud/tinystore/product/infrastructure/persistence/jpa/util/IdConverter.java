...
public final class IdConverter {
	...
	/**
	 * Convert ProductId to Long for JPA queries Strategy: Use hashCode for stable mapping
	 */
	...
	/**
	 * Convert Long to ProductId Note: This is a reconstruction method for domain objects
	 */
