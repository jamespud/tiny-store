 ...
 * <p>
 * Endpoints: - POST /api/products/calculate-price - Calculate final price with rules
 * <p>
 * Security: - Requires X-Tenant-Id header - Public endpoint (no authentication required for price
 * calculation)
 * <p>
 * Response includes: - Final price - Applied adjustments (rule by rule) - SKU version - Rule
 * versions (for order recalculation) - Price signature (for tampering detection)
 */
@Slf4j
@RestController
