 ...
 * <p>
 * Responsibilities: - Register rule types with their construction logic - Provide factory methods
 * for rule instantiation from JSONB - Support polymorphic rule deserialization
 * <p>
 * Rule types to register: - PercentOffRule: Percentage discount - FlatOffRule: Fixed amount
 * discount - TimeWindowPercentOffRule: Time-bounded percentage discount - TagFlatOffRule: Tag-based
 * flat discount - BuyXGetYRule: Promotional bundle rule
 * <p>
 * Usage: 1. Register rule types at startup 2. PricingRuleMapper uses registry to construct domain
 * rules from entities 3. SimpleRuleEngine uses registry for rule interpretation
 */
@Component
