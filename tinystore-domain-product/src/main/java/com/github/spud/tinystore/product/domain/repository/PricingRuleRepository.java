 ...
 * <p>
 * Provides access to pricing rules filtered by: - Tenant (mandatory for all operations) - Product
 * ID - Category ID - User tags - Time window (effective/expire) - Status
 * <p>
...
public interface PricingRuleRepository {
	...
	/**
	 * Find active pricing rules for a specific product Returns rules applicable at current time
	 *
	 * @param tenantId    Tenant identifier
	 ...
	 */
	List<PricingRule> findActiveRulesByProduct(String tenantId, String productId,
		Instant currentTime);

	/**
	 * Find active pricing rules for a category Returns rules applicable at current time
	 *
	 * @param tenantId    Tenant identifier
	 ...
	 * @return List of active rules ordered by priority (descending)
	 */
	List<PricingRule> findActiveRulesByCategory(String tenantId, String categoryId,
		Instant currentTime);
	 ...
	 * @return List of active rules ordered by priority (descending)
	 */
	List<PricingRule> findActiveRulesByTags(String tenantId, List<String> userTags,
		Instant currentTime);

	/**
	 * Find all active rules within tenant Used for cache preload or batch operations
	 *
	 * @param tenantId    Tenant identifier
	 * @param currentTime Current time for window check
