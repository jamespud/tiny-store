 ...
 * <p>
 * This filter runs with highest precedence to ensure tenant context is available for all subsequent
 * processing.
 * <p>
 * Tenant ID extraction order: 1. X-Tenant-Id request header (preferred) 2. If missing, return 400
 * Bad Request
 * <p>
 * The tenant ID is injected into request-scoped TenantContext bean for use by repositories and
 * services.
 */
@Slf4j
@Component
