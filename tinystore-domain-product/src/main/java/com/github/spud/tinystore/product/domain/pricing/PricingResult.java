...
public class PricingResult {
    public static class Adjustment {
        ...
        public Adjustment(String ruleCode, String description, Money delta) {
            this.ruleCode = ruleCode; this.description = description; this.delta = delta;
        }
    }
    ...
    public PricingResult(Money basePrice) {
        this.basePrice = basePrice; this.finalPrice = basePrice;
    }

    public void apply(Adjustment adj) { this.finalPrice = this.finalPrice.add(adj.delta); this.adjustments.add(adj); }
