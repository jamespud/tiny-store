 ...
 * <p>
 * Responsibilities: 1. Serialize domain events to JSONB 2. Write to outbox table in same
 * transaction as domain changes 3. Coordinate with background worker for Kafka publishing
 * <p>
 * Integration points: - Uses tinystore-library-infrastructure's Outbox components (if available) -
 * Or implements standalone outbox write + polling worker
 * <p>
 * Configuration: - Enabled via feature.outbox.enabled - Falls back to LoggingEventPublisher when
 * disabled
 * <p>
