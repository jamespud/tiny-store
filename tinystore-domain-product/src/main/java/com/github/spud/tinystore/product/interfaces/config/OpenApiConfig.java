 ...
 * <p>
 * Configures Springdoc OpenAPI for automatic API documentation generation. Documentation will be
 * available at: - Swagger UI: /swagger-ui.html - OpenAPI JSON: /v3/api-docs - OpenAPI YAML:
 * /v3/api-docs.yaml
 * <p>
 * Security: - JWT Bearer Token authentication required for all endpoints - Token should be included
