 ...
 * 
 * Query methods for complex rule filtering:
 * - By tenant, product, category, tags
 * - By effective time window
...
public interface JpaPricingRuleRepository extends JpaRepository<PricingRuleEntity, Long>, 
     ...
     * Enforces uniqueness constraint uk_tenant_rule_code
     * 
    ...
    /**
     * Find all active pricing rules within tenant and time window
     * Used for batch pricing or preload
     * 
     * @param tenantId Tenant identifier
     * @param currentTime Current time for window check
