...
public class PricingRuleRepositoryAdapter implements PricingRuleRepository {
	...
	@Override
	public List<PricingRule> findActiveRulesByProduct(String tenantId, String productId,
		Instant currentTime) {
	...
	@Override
	public List<PricingRule> findActiveRulesByCategory(String tenantId, String categoryId,
		Instant currentTime) {
		LocalDateTime time = LocalDateTime.ofInstant(currentTime, ZoneId.systemDefault());
	...
	@Override
	public List<PricingRule> findActiveRulesByTags(String tenantId, List<String> userTags,
		Instant currentTime) {
