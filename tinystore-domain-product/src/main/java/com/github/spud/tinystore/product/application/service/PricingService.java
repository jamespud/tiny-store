...
/**
 * PricingService - Application service for dynamic pricing calculation Uses rule engine to evaluate
 * pricing rules and calculate final prices
 */
@Slf4j
@Service
...
public class PricingService {
	...
	/**
	 * Calculate price for a given context (SKU, user, time) Applies all matching active rules in
	 * priority order
	 */
	...
	/**
	 * Preview price calculation without caching Useful for admin preview or testing
	 */
