 ...
 * <p>
 * Maps exceptions to appropriate HTTP status codes and standardized response format. Generates
 * trace IDs for troubleshooting and logs exceptions appropriately.
 * <p>
 * Response format: { "code": "ERROR_CODE", "message": "Human-readable error message", "traceId":
 * "unique-trace-id" }
 */
@Slf4j
...
public class GlobalExceptionHandler {
	...
	/**
	 * Handle IllegalArgumentException - Invalid input data Returns 400 Bad Request
	 */
	...
	/**
	 * Handle validation errors from @Valid annotation Returns 400 Bad Request with field-level error
	 * details
	 */
	...
	/**
	 * Handle NoSuchElementException and EntityNotFoundException Returns 404 Not Found
	 */
	...
	/**
	 * Handle OptimisticLockException - Concurrent modification detected Returns 409 Conflict
	 */
	...
	/**
	 * Handle DataIntegrityViolationException - Database constraint violation Typically unique
	 * constraint or foreign key violations Returns 409 Conflict
	 */
	...
	/**
	 * Handle AccessDeniedException - Insufficient permissions Returns 403 Forbidden
	 */
	...
	/**
	 * Handle all other exceptions - Internal server error Returns 500 Internal Server Error
	 */
