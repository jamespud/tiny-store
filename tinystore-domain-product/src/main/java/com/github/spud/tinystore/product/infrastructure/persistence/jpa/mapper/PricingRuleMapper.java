 ...
 * - Convert domain PricingRule to PricingRuleEntity for persistence
 * - Serialize rule content to JSONB format
 * - Convert PricingRuleEntity to domain PricingRule for retrieval
 * - Deserialize JSONB content back to rule-specific types
 * - Coordinate with RuleRegistry for type-specific rule construction
 */
@Component
