package com.github.spud.tinystore.inventory.application;
...
/**
 * Inventory 应用服务 Refactored 2025-09-14: 引入新 API
 * (reserve/confirm/release/adjustTotal/queryAvailable/batchQueryAvailable/sync) Deprecated
 * 旧方法：deductReserve / increaseReserve / increaseTotal / decreaseTotal /
 * batchQueryAvailable(List<String>)
 */
@Service
