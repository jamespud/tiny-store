...
import com.github.spud.tinystore.inventory.domain.enums.ReservationState;
import com.github.spud.tinystore.inventory.domain.model.Reservation;
import org.springframework.stereotype.Service;

/**
 * 预留领域服务（状态流转、创建占位） 状态迁移矩阵（PENDING -> CONFIRMED / RELEASED / EXPIRED / FAILED）
 * TODO(inv): 实现校验逻辑：
...
public class ReservationDomainService {
	...
	public Reservation createPendingReservation(String shopId, String skuId, int quantity,
		Integer expireSeconds, String operationId) {
