package com.github.spud.tinystore.product.domain.constant;
...
public class RedisConstant {
	...
	// 预留记录状态 key 前缀
	public static final String RESERVATION_STATE_KEY_PREFIX = STOCK_KEY_PREFIX + "reservation:state:"; // reservation:state:{reservationId}
	// 预留记录 TTL 标记（可选）
