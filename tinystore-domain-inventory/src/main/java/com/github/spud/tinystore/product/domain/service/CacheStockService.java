...
import com.github.spud.tinystore.product.domain.constant.RedisConstant;
...
/**
 * 缓存层库存操作（含计划新增查询占位）
 * Refactored: 迁移方法命名 increaseReserved/decreaseReserved -> increaseReserve/decreaseReserve
 */
@Slf4j
@Service
public class CacheStockService {
	...
	// === 新增占位方法 ===
	public Optional<Stock> getSnapshot(String shopId, String skuId) {
